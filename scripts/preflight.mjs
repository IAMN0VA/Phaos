...
for (const phrase of ['data-mode="gray"','data-mode="thermal"','data-mode="real"','id="measureTool"','id="markerTool"','id="fileInput"','id="folderInput"','id="axisToggle"','id="splicerToggle"']) {
